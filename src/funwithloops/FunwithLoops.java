 ...
 * Sean Luo 29/03/2018
 * FunwithLoop.java
 * This program calculates the FunwithLoop
 */
...
public class FunwithLoops extends javax.swing.JFrame {
    ...
    int starting,ending;
    String counting =" ";
    //starting represent the starting number
    //ending represent the ending number
    starting =  Integer.parseInt(jTextField1.getText());
    ending =  Integer.parseInt(jTextField2.getText());
